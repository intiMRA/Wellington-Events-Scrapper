...
def load_models_from_file():
    classification_model = load_model(paths.model_path("trained_model_kid_friendly"))
    with open(paths.model_path('tokenizer_config_kid_friendly.json'), 'r', encoding='utf-8') as f:
