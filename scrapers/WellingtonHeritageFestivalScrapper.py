...
class WellingtonHeritageFestivalScrapper:
    ...
    def fetch_events(previous_urls: Set[str], previous_titles: Optional[Set[str]]) -> List[EventInfo]:
        out_file, urls_file, banned_file = FileUtils.get_files_for_scrapper(ScraperName.WELLINGTON_HERITAGE_FESTIVAL)
        previous_urls = previous_urls.union(set(FileUtils.load_banned(ScraperName.WELLINGTON_HERITAGE_FESTIVAL)))
        ...
        if not events_json_list:
            return []
        festival_file_name = paths.root_path("heritage-festival.json")
        ...
        CurrentFestivals.CURRENT_FESTIVALS_DETAILS.append({
            ...
            "icon": "heritage",
            f"url": "https://raw.githubusercontent.com/intiMRA/Wellington-Events-Scrapper/refs/heads/main/heritage-festival.json"
        })
            ...
            if title in old_events.keys():
                ...
                try:
                    event = EventInfo(name=title,
                                     ...
                                     url=url,
                                     venue=venue,
                                     source=ScraperName.WELLINGTON_HERITAGE_FESTIVAL,
